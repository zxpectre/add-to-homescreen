...
( function ( window, document ) {
	...
	*/
	...
	object.Assign( {}, ath, {
		...
		isSamsung: /Samsung/.test( _ua ),
		isFireFox: /Firefox/.test( _ua ),
		isChromium: ( "onbeforeinstallprompt" in window ),
	...
	ath.isCompatible = ( ath.isMobileSafari && ath.OSVersion >= 6 ) ||
		( ath.isSamsung || ath.isFireFox || ath.isChromium );
	...
	ath.Class = function ( options ) {
		...
		//TODO: change detectHomescreen to look for queryString from manifest start URL
		//TODO: sync manifest configuration for startURL to be used here
		//recognize iOS does not honor the actual start URL yet, it maps to the URL the user is currently visiting when the A2HS happens
		...
		//TODO: instead of injecting HTML for modal, use hidden modal/div/container in HTML
		...
		if ( this.options.detectHomescreen ) {
			...
			// TODO: not sure if this is a good way to do this. Should instead check if A2HS should be triggered based on tokens persisted in storage
	...
	ath.Class.prototype = {
		...
		show: function ( force ) {
			...
			// TODO: make applicationIcon a configuration option and not a touch icon dependency. to brittle
			...
			// add the action icon
			// TODO: migrate to a markup snippet. Should also be able to eliminate language here as it can be done on the server, etc.
			...
			// TODO: styles should be completely in the CSS file
			this.element.style.cssText = 'transition-property:transform,opacity;transition-duration:0s;transition-timing-function:ease-out;';
		...
		_show: function () {
			...
			// TODO: replace position control with the position: fixed; property
			...
			// kick the animation
			// TODO: probably can replace with pure CSS
			setTimeout( function () {
		...
		//eliminate since this should all be done in CSS
